...
# Our goal is to prove that binary search is faster than naive search
# By the term naive search we mean the following:  scan entire list and ask if its equal to the target


# Essence of binary search:
# If you have a sorted list and you want to search this array for something,
#  One approach  could be going through each item in the list and ask, is this equal to what we're looking for?
